 ...
 * Use the [DeadliftFrontSquatFragment.newInstance] factory method to
...
class DeadliftFrontSquatFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DeadliftFrontSquatFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DeadliftFrontSquatFragment().apply {
